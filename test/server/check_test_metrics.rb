...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=', 150 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 1274 ],
    [ 'test.lines.missed',     test_cov['lines'   ]['missed'], '<=',    0 ],
    [ 'test.branches.total',   test_cov['branches']['total' ], '<=',    6 ],
    [ 'test.branches.missed',  test_cov['branches']['missed'], '<=',    1 ],
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 711 ],
    [ 'code.lines.missed',     code_cov['lines'   ]['missed'], '<=', 0   ],
    [ 'code.branches.total',   code_cov['branches']['total' ], '<=', 92  ],
