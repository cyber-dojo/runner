...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=', 143 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 1188 ],
    ...
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 683 ],
    [ 'code.lines.missed',     code_cov['lines'   ]['missed'], '<=', 0   ],
    [ 'code.branches.total',   code_cov['branches']['total' ], '<=', 88  ],
