...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=', 145 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 1220 ],
    [ 'test.lines.missed',     test_cov['lines'   ]['missed'], '<=',    0 ],
    [ 'test.branches.total',   test_cov['branches']['total' ], '<=',    4 ],
    [ 'test.branches.missed',  test_cov['branches']['missed'], '<=',    0 ],
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 705 ],
    [ 'code.lines.missed',     code_cov['lines'   ]['missed'], '<=', 0   ],
    [ 'code.branches.total',   code_cov['branches']['total' ], '<=', 90  ],
