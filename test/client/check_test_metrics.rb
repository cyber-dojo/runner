...
# - reports/client/coverage_metrics.json generated in coverage_metrics_formatter.rb by simplecov. See coverage.rb
...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=', 69 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 483 ],
    [ 'test.lines.missed',     test_cov['lines'   ]['missed'], '<=',   0 ],
    [ 'test.branches.total',   test_cov['branches']['total' ], '<=',   7 ],
    [ 'test.branches.missed',  test_cov['branches']['missed'], '<=',   1 ],
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 119 ],
